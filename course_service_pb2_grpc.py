...
class CourseServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCourse = channel.unary_unary(
                '/autotests.CourseService/GetCourse',
...
def add_CourseServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'autotests.CourseService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('autotests.CourseService', rpc_method_handlers)
